...
For detailed mathematical formulations, see [MATHEMATICAL_APPENDIX.md](MATHEMATICAL_APPENDIX.md).
...
**Data Sources:** 
1. **United States Geological Survey (USGS)** (Open Access)
2. **International Seismological Centre (ISC)**: ISC-GEM Global Instrumental Earthquake Catalogue (Ver. 11.0). (Credentials on demand)
3. **National Research Institute for Earth Science and Disaster Resilience (NIED)**, Japan (Hi-net/F-net). (Restricted access, subject to approval)
